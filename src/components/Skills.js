...
import { SiMongodb, SiMui, SiMysql, SiRedux, SiExpress, SiGithub, SiMicrosoftsqlserver, SiCanva, SiAdobeillustrator, SiAdobexd, SiAdobephotoshop, SiDotnet, SiAntdesign, SiVuedotjs, SiAngular } from 'react-icons/si';
import { TbApi } from 'react-icons/tb';
import SkillsImg from '../components/images/dev9.png'
import './Skills.css';
import AOS from 'aos';
...
function Skills() {
    ...
    return (
        <div className="skills" id='skills'>
            ...
            <h2 data-aos="fade-up" className="skills-heading2">__what i can do__</h2>
            <Row className="mt-4">
                <Col md={12} className="text-center" >
                    <Card className="skills-card1-img" style={{ border: 'none', backgroundColor: 'transparent' }}>
                        <Card.Img data-aos="fade-up" variant="center" src={SkillsImg} className="Skills-img" />
                    </Card>
                </Col>
            </Row>
            ...
            <Row className="skills-row">
                <Col md={4} className="skills-column">
                    <Card data-aos="fade-right" className="skills-card" style={{ border: 'none', backgroundColor: 'transparent' }}>
                        <Card.Body>
                ...
                <Col md={4} className="skills-column">
                    <Card data-aos="fade-up" className="skills-card" style={{ border: 'none', backgroundColor: 'transparent' }}>
                        <Card.Body>
                            <Card.Title className="skills-card-title">
                                Back-end
                            </Card.Title>
                ...
                <Col md={4} className="skills-column">
                    <Card data-aos="fade-left" className="skills-card" style={{ border: 'none', backgroundColor: 'transparent' }}>
                        <Card.Body>
                            <Card.Title className="skills-card-title">
                                Others
                            </Card.Title>
